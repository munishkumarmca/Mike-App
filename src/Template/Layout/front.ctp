...
//$this->prepend('css', $this->Html->css(['bootstrap/bootstrap', 'plugins/jquery.confirm/jquery-confirm']));

$this->prepend('css', $this->Html->css(['bootstrap/bootstrap4', 'front', 'common-style', 'plugins/themify-icons/themify-icons.min.css', 'plugins/animate.css/animate.min.css', 'plugins/fontawesome/css/font-awesome.min.css', 'plugins/hide-show-password/css/example.wink.css', 'plugins/perfect-scrollbar/perfect-scrollbar.min.css', 'plugins/switchery/switchery.min.css', 'theme2/css/styles.css', 'theme2/css/plugins.css','theme2/css/themes/theme-1.css' ]));
