...
Sizes: [
	...
	<head>
		...
		<title><?php echo Configure::read('App.title'); ?></title>
		<style type="text/css">
			/* RESET STYLES */
				...
				<tr>
					<td align="center" valign="top" id="bodyCell">
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="top" class="textContent">
																		<h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;"><?php echo Configure::read('App.title'); ?></h1>
																		<h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#205478;line-height:135%;"><?php echo Configure::read('App.title'); ?></h2>
						...
						<!--
							...
							that spans the width of the page.
						-->
						<table bgcolor="#000" border="0" cellpadding="0" cellspacing="0" width="500" id="emailFooter">
																...
																<tr>
																	<td valign="top" bgcolor="#000">
																		...
																		<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																			<div><p style = 'color: #fff;'><?php printf('&copy;%s %s', date('Y'), Configure::read('App.title')); ?></p></div>
																		</div>
